...
if [ ! -z ${_BUILD_ARG_JLINK_TOOLS} ]; then
	...
	curl -s -X POST -d "accept_license_agreement=accepted&submit=Download+software" -o "$HOME/jlink.deb" "https://www.segger.com/downloads/jlink/JLink_Linux_$version.deb"
